...
| Mem0 (官方) | 85.47% | **81.98%** | **83.73%** |
| A-Mem (官方) | 87.43% | 75.94% | 81.69% |

**关键发现：**

1. **英文**：CogMem 达到 75.16%（较 FTS5 基线提升 10.31pp）。Mem0 最高为 81.98%。
...
| 类别 | 问题数 | 基线 | 认知检索 | CogMem | A-Mem |
|------|:------:|:----:|:--------:|:------:|:-----:|
| 单跳 | 282 | 64.9% (183) | 61.0% (172) | 71.3% (201) | **80.5% (227)** |
| 多跳 | 321 | 63.2% (203) | 76.0% (244) | **82.2% (264)** | 65.7% (211) |
| 时序 | 96 | 54.2% (52) | 44.8% (43) | **62.5% (60)** | 58.3% (56) |
| 对抗性 | 841 | 66.6% (560) | 71.2% (599) | 75.1% (632) | **80.3% (675)** |

CogMem 在多跳推理上取得最佳成绩（82.2%，较基线提升 19.0pp，较 A-Mem 提升 16.5pp），验证了扩散激活在复杂推理中的价值。
...
| A-Mem | 408 分钟 | 15 分钟 | N/A | 1.92M | 2,734 | N/A |
| Mem0 | 87 分钟 | N/A | N/A | N/A | 6,442 | N/A |

**观察：**
- A-Mem 写入速度比 CogMem 慢 2.6 倍（408 分钟 vs 155 分钟），因为每条记忆需要 3 次 LLM 调用。
